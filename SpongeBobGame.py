...
#** Define treasure locations, only 3, and crabby patty location, only 1
...
if(tr3_cell == tr1_cell or tr3_cell == tr2_cell):
    tr3_cell = random.choice(empty_cells)
crabby_patty = random.choice(empty_cells)
if(crabby_patty == tr1_cell or crabby_patty == tr2_cell or crabby_patty == tr3_cell):
    crabby_patty = random.choice(empty_cells)
...
patty_x = crabby_patty[0]*SQ_SIZE
patty_y = crabby_patty[1]*SQ_SIZE
...
cp_col,cp_row = crabby_patty
grid[cp_col][cp_row] = 3
#print(grid)
...
crabby_patty_im = pygame.image.load("crabbypatty.png")
crabby_patty_im = pygame.transform.scale(crabby_patty_im, (SQ_SIZE,SQ_SIZE))
...
while True:
    for event in pygame.event.get():
        ...
        if (grid[col][row] == 2 or grid[col1][row1] == 2 or grid[col2][row2] == 2 or grid[col3][row3] == 2):
            ...
            #print(SCORE)
        if (grid[col][row] == 3 or grid[col1][row1] == 3 or grid[col2][row2] == 3 or grid[col3][row3] == 3):
            if (check == crabby_patty or check1 == crabby_patty or check2 == crabby_patty or check3 == crabby_patty):
                cp = False
                grid[cp_col][cp_row] = 0
                LIVES += 1
        # Update Score:
        ...
        if (cp):
            DISPLAYSURF.blit(crabby_patty_im, (patty_x, patty_y))
